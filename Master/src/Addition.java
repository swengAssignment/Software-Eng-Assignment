...
public class Addition extends JPanel{
   ...
   //     equals1.setBackground(frame.getBackground());
     ...
     //   equals2.setBackground(frame.getBackground());
        ...
        /****************************/
        add(topPanel, "pushx,center,wrap");
        topPanel.add(topText);

        add(numValuesLabel, "left, split 2");
        add(numValues, "left, wrap");

        add(enterValuesPanel, "grow, push, left, split 2, sg 3");
        add(showEnteredPanel, "grow, push, wrap, sg 3");
        ...
        add(showHowPanel, "right, grow, wrap, pushx");
